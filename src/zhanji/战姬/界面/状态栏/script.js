...
var DAILY_QUEST_POOL = [
    ...
    const SHOP_ITEMS = [
      ...
      { category:'养成类', name:'挚爱糖果', desc:'好感度+30~50（上限80）', price:600 },
      ...
      { category:'特殊类', name:'稀有技能学习机', desc:'学会一个稀有品质技能（随机）', price:1500 },
      { category:'特殊类', name:'史诗技能学习机', desc:'学会一个史诗品质技能（随机）', price:3000, limit:'每周限购3' },
      { category:'特殊类', name:'传说技能学习机', desc:'学会一个传说品质技能（随机）', price:10000, limit:'极稀有' },
